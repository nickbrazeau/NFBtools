...
## Read in Data
```{r readin, echo=T, warning=F, message=F, results="asis"}
# download this file: ftp://ngs.sanger.ac.uk/production/malaria/pf-crosses/1.0/3d7_hb3.combined.final.vcf.gz

vcfRobject <- vcfR::read.vcfR("~/Downloads/3d7_hb3.combined.final.vcf.gz")
vcfRobject <- vcfRobject[is.biallelic(vcfRobject)] # biallelic 
...
## PCA
```{r pca, echo=T, warning=F, message=F, results="asis"}
...
## Network Analysis
```{r network, echo=T, warning=F, message=F, results="asis"}
